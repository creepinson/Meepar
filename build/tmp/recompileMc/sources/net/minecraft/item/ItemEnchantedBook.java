...
public class ItemEnchantedBook extends Item
{
    ...
    public void addEnchantment(ItemStack stack, EnchantmentData enchantment)
    {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i)
        {
            ...
            if (Enchantment.getEnchantmentByID(nbttagcompound.getShort("id")) == enchantment.enchantment)
            {
        ...
        if (flag)
        {
            ...
            nbttagcompound1.setShort("id", (short)Enchantment.getEnchantmentID(enchantment.enchantment));
