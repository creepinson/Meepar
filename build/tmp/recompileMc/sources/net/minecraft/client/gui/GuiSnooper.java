...
public class GuiSnooper extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiSnooper.this.fontRenderer.drawString((String)GuiSnooper.this.keys.get(entryID), 10, yPos, 16777215);
            GuiSnooper.this.fontRenderer.drawString((String)GuiSnooper.this.values.get(entryID), 230, yPos, 16777215);
        }
