...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int insideLeft, int yPos, int insideSlotHeight, int mouseXIn, int mouseYIn)
        {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRenderer, statbase.getStatName().getUnformattedText(), insideLeft + 2, yPos + 1, entryID % 2 == 0 ? 16777215 : 9474192);
            String s = statbase.format(GuiStats.this.stats.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s, insideLeft + 2 + 213 - GuiStats.this.fontRenderer.getStringWidth(s), yPos + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int insideLeft, int yPos, int insideSlotHeight, int mouseXIn, int mouseYIn)
        {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s, insideLeft + 2 - 10, yPos + 1, 16777215);
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s1, insideLeft + 2, yPos + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRenderer, s2, insideLeft + 2, yPos + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
        }
    }
}