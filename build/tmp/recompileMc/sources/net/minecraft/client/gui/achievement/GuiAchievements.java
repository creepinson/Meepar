...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void drawTitle()
    {
        int i = (this.width - this.imageWidth) / 2;
        int j = (this.height - this.imageHeight) / 2;
        this.fontRenderer.drawString(I18n.format("gui.achievements", new Object[0]), i + 15, j + 5, 4210752);
    }
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        for (int i6 = 0; i6 < achievementList.size(); ++i6)
        {
            ...
            if (l6 >= -24 && j7 >= -24 && (float)l6 <= 224.0F * this.zoom && (float)j7 <= 155.0F * this.zoom)
            {
                ...
                this.itemRender.renderItemAndEffectIntoGUI(achievement2.icon, l6 + 3, j7 + 3);
        ...
        if (achievement != null)
        {
            ...
            if (s != null)
            {
                this.fontRenderer.drawStringWithShadow(s, (float)i7, (float)k7, this.statFileWriter.canUnlockAchievement(achievement) ? (achievement.getSpecial() ? -128 : -1) : (achievement.getSpecial() ? -8355776 : -8355712));
            }
        }
