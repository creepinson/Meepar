...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    class Details extends GuiSlot
    {
        ...
        {
            FlatLayerInfo flatlayerinfo = (FlatLayerInfo)GuiCreateFlatWorld.this.generatorInfo.getFlatLayers().get(GuiCreateFlatWorld.this.generatorInfo.getFlatLayers().size() - entryID - 1);
            ...
            GuiCreateFlatWorld.this.fontRenderer.drawString(s, insideLeft + 18 + 5, yPos + 3, 16777215);
            String s1;
            ...
            else if (entryID == GuiCreateFlatWorld.this.generatorInfo.getFlatLayers().size() - 1)
            {
            ...
            GuiCreateFlatWorld.this.fontRenderer.drawString(s1, insideLeft + 2 + 213 - GuiCreateFlatWorld.this.fontRenderer.getStringWidth(s1), yPos + 3, 16777215);
        }
