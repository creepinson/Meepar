...
public class GuiAchievement extends Gui
{
    ...
    public void displayUnformattedAchievement(Achievement achievementIn)
    {
        ...
        this.achievement = achievementIn;
    ...
    {
        if (this.achievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().player != null)
        {
            ...
            this.renderItem.renderItemAndEffectIntoGUI(this.achievement.icon, i + 8, j + 8);
            GlStateManager.disableLighting();
