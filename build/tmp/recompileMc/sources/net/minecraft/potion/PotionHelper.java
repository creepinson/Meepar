...
public class PotionHelper
{
     ...
     */
    public static void registerPotionItemConversion(ItemPotion input, PotionHelper.ItemPredicateInstance reagent, ItemPotion output)
    {
        POTION_ITEM_CONVERSIONS.add(new PotionHelper.MixPredicate(input, reagent, output));
    }

    /**
     * Registers an itempredicate that identifies a potion item, for example Items.potionItem, or Items.lingering_potion
     */
    public static void registerPotionItem(PotionHelper.ItemPredicateInstance potionItem)
    {
        POTION_ITEMS.add(potionItem);
    }
