...
public class EntityShulker extends EntityGolem implements IMob
{
    ...
    class AIAttackNearest extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        protected AxisAlignedBB getTargetableArea(double targetDistance)
        {
            ...
            return enumfacing.getAxis() == EnumFacing.Axis.X ? this.taskOwner.getEntityBoundingBox().grow(4.0D, targetDistance, targetDistance) : (enumfacing.getAxis() == EnumFacing.Axis.Z ? this.taskOwner.getEntityBoundingBox().grow(targetDistance, targetDistance, 4.0D) : this.taskOwner.getEntityBoundingBox().grow(targetDistance, 4.0D, targetDistance));
        }
    }
