...
public class EntityAIBeg extends EntityAIBase
{
    ...
    {
        return !this.player.isEntityAlive() ? false : (this.wolf.getDistanceSqToEntity(this.player) > (double)(this.minPlayerDistance * this.minPlayerDistance) ? false : this.timeoutCounter > 0 && this.hasTemptationItemInHand(this.player));
    }
