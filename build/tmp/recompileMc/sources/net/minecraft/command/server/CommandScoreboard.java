...
public class CommandScoreboard extends CommandBase
{
    ...
    protected void listTeams(ICommandSender sender, String[] args, int startIndex, MinecraftServer server) throws CommandException
    {
        ...
        if (args.length > startIndex)
        {
            ...
            TextComponentTranslation textcomponenttranslation = new TextComponentTranslation("commands.scoreboard.teams.list.player.count", new Object[] {Integer.valueOf(collection.size()), scoreplayerteam.getName()});
        ...
        else
        {
            ...
            {
                sender.sendMessage(new TextComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] {scoreplayerteam1.getName(), scoreplayerteam1.getDisplayName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size())}));
            }
        }
    }
    ...
    protected void emptyTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server) throws CommandException
    {
        ...
        if (scoreplayerteam != null)
        {
            ...
            else
            {
                ...
                notifyCommandListener(sender, this, "commands.scoreboard.teams.empty.success", new Object[] {Integer.valueOf(collection.size()), scoreplayerteam.getName()});
            }
        }
    }
