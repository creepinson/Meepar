...
public class WorldInfo
{
    ...
    private void updateTagCompound(NBTTagCompound nbt, NBTTagCompound playerNbt)
    {
        ...
        for (Entry<Integer, NBTTagCompound> entry : this.dimensionData.entrySet())
        {
            ...
            nbttagcompound1.setTag(String.valueOf(entry.getKey()), (NBTBase)entry.getValue());
        }
    ...
    {
        NBTTagCompound nbttagcompound = (NBTTagCompound)this.dimensionData.get(dimensionID);
