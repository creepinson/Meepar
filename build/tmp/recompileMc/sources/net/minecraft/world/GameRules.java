...
public class GameRules
{
    ...
    {
        GameRules.Value gamerules$value = (GameRules.Value)this.rules.get(key);
    ...
    {
        GameRules.Value gamerules$value = (GameRules.Value)this.rules.get(name);
    ...
    public NBTTagCompound writeToNBT()
    {
        ...
        {
            GameRules.Value gamerules$value = (GameRules.Value)this.rules.get(s);
